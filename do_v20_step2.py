...
v15_hash = result.stdout.strip().split()[0]
ver = json.load(open('version.json'))
v10 = open('VERSION_1.0_SAVE.md').read()
v15 = open('VERSION_1.5_SAVE.md').read()
content = f'''# ================================================================
...
**Previous Version:** v1.5 (commit {v15_hash})
...
| 1.5 | {v15_hash} | All systems integrated and working |
...
*March 11, 2026*
'''
with open('VERSION_2.0_SAVE.md', 'w', encoding='utf-8') as f:
    f.write(content)
print('VERSION_2.0_SAVE.md created successfully!')
